...
class OpenAICompatibleProvider(TranslationProvider):
    ...
    def build_messages(self, text: str, source_lang: str, target_lang: str) -> List[Dict[str, str]]:
        ...
        system_prompt = (
            "You are a professional translation engine. Translate the provided text "
            f"from {source_lang} to {target_lang}. "
            "Return ONLY the translated text without any explanations, notes, or opening/closing remarks. "
            "Preserve the original meaning, tone and any special characters."
        )
        return [
